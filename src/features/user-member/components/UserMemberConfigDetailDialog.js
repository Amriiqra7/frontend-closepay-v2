...
export default function UserMemberConfigDetailDialog({
  open,
  onClose,
  data,
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: '#6b7280', fontSize: '0.75rem', mt: 0.5, ml: 5 }}>
              Kolom akan ditampilkan pada formulir saat akan melakukan penambahan user member.
          ...
          <Box>
            ...
            <Typography variant="body2" sx={{ color: '#6b7280', fontSize: '0.75rem', mt: 0.5, ml: 5 }}>
              ...
              penambahan user member. Anda juga dapat mengatur kolom ini sebagai salah satu kolom
          ...
          <Box>
            ...
            />
            <Typography variant="body2" sx={{ color: '#6b7280', fontSize: '0.75rem', mt: 0.5, ml: 5 }}>
              Kolom akan di atur sebagai kolom yang dapat diedit oleh user member. Anda juga dapat
              mengatur kolom ini sebagai kolom yang tidak dapat diedit oleh user member pada lain
              waktu.
            </Typography>
          </Box>
        </Box>
