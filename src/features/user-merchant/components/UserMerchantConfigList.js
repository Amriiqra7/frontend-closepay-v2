...
import UserMerchantConfigDetailDialog from './UserMerchantConfigDetailDialog';
...
export default function UserMerchantConfigList() {
  ...
  const handleAdd = useCallback(() => {
    router.push('/admin/utama/data-user/user-merchant/konfig-user/new');
  }, [router]);
    ...
    <Box sx={{ width: '100%' }}>
      ...
      <Box sx={{ mb: 3 }}>
        <Typography variant="body2" sx={{ color: '#6b7280', lineHeight: 1.6 }}>
          Konfigurasi ini akan diterapkan pada formulir data saat melakukan penambahan user merchant, upload/unggah merchant, dan registrasi mandiri. Anda dapat menambahkan dan mengatur data lain yang dibutuhkan.
        </Typography>
      </Box>
      ...
      {/* Detail Dialog */}
      <UserMerchantConfigDetailDialog
