...
export default function UserMerchantConfigNew() {
    ...
    <Box sx={{ width: '100%' }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 2, mt: 3 }}>
          ...
          <Tooltip
            title="Anda dapat mengatur data yang ada untuk diterapkan ke merchant anda"
            arrow
            placement="top"
          >
      ...
      <Box>
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Tooltip
              title="Anda Dapat menambahkan data tambahan lainnya yang tidak tersedia pada Basic Data untuk diterapkan pada merchant anda sesuai dengan kebutuhan anda"
              arrow
              placement="top"
            >
              <IconButton size="small" sx={{ p: 0.5 }}>
      ...
      >
        <Button
          variant="outlined"
          onClick={() => router.push('/admin/utama/data-user/user-merchant/konfig-user')}
          sx={{
            textTransform: 'none',
            borderColor: '#dc2626',
            color: '#dc2626',
        ...
        <Button
          ...
          onClick={() => {
            ...
            router.push('/admin/utama/data-user/user-merchant/konfig-user');
          }}
          sx={{
            textTransform: 'none',
            bgcolor: '#1976d2',
