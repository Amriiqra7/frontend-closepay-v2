...
export default function CompanyKonfigurasiPenawaranEmailTelepon() {
  ...
  const handleSimpan = () => {
    console.log('Saving konfigurasi penawaran email & telepon:', { companyId, aktif });
    setIsEditMode(false);
  };
        ...
        <Box sx={{ p: 3 }}>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
            <Typography variant="body2" sx={{ fontSize: '0.875rem', lineHeight: 1.6 }}>
              Atur konfigurasi penawaran email & telepon pada perusahaan <strong>{companyName}</strong>
            </Typography>
            <FormControlLabel
              control={
                <Switch
