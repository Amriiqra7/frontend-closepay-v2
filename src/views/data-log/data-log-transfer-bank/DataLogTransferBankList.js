...
import DataLogTransferBankDetailDialog from './DataLogTransferBankDetailDialog';
...
const generateMockLogs = () => {
  const logs = [];
  const events = ['TRANSFER BANK', 'TRANSFER BANK DEBIT', 'TRANSFER BANK CREDIT'];
    ...
    logs.push({
      ...
      responseDetail: {
        ...
        error: i % 3 === 0 ? {
          ...
          message: `Transfer failed [Code: da22b${i}]`,
          data: '',
          paging: '',
        } : null,
        event: events[i % events.length],
...
export default function DataLogTransferBankList() {
  ...
  return (
    <Box sx={{ width: '100%', height: '100%' }}>
      ...
      {/* Detail Dialog */}
      <DataLogTransferBankDetailDialog
